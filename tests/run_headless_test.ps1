...
Remove-Item -Recurse -Force (Join-Path $GhidraInstall "Ghidra\Extensions\$module") -ErrorAction SilentlyContinue
Remove-Item -Recurse -Force (Join-Path $extDir $module) -ErrorAction SilentlyContinue
